...
// }, [searchParams, navigate]);
  ...
  return (
    ...
    <input className='text-slate-600 border rounded-full w-[50rem] h-full text-2xl font-semibold px-[20px]' placeholder='Search a movie or tv show' value={formData} onChange={handleChange}/>
