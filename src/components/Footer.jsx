...
const Footer = () => {
  return (
    <section class="bg-slate-900 end-0 ">
      <div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
        <nav class="flex flex-wrap justify-center -mx-5 -my-2">
          <div class="px-5 py-2">
            <a
              href="#"
              class="text-base leading-6 text-white hover:text-rose-700"
            >
              Terms of Use
            </a>
          </div>
          <div class="px-5 py-2">
            <a
              href="#"
              class="text-base leading-6 text-white hover:text-rose-700 hover: outline-2"
            >
              Privacy Policy
            </a>
          </div>
        ...
        <p className="text-gray-400 text-center px-24">
          ...
          explicabo laudantium ad officia eos esse ipsa totam id ullam?
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Est nobis,
          soluta quidem omnis error excepturi quia voluptas nostrum sequi ipsum
          explicabo laudantium ad officia eos esse ipsa totam id ullam?
        </p>
        <div class="flex justify-center mt-8 space-x-6">
          <a href="#" class="text-white hover:text-rose-500">
